...
const PublishModal = (params: props) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      body:
        "Bonjour," +
        " \n" +
        "Veuillez trouver ci-joint la facture pour mon activité de ce mois ainsi que l'attestation habituelle." +
        " \n" +
        "Cordialement",
    },
    ...
    onSubmit: (values) => {
      if (values.id) {
        ...
        InvoiceService.publishInvoice(values.id, mail)
          .then((invoice) => {
            console.log(invoice);
        ...
        <Box sx={style}>
          ...
          <form onSubmit={formik.handleSubmit}>
            <TextField
              ...
              variant="filled"
              type="email"
              label={t("publishModal.recipient")}
